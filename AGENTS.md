...
- Except for graph templates themselves, buddy long-term editable data should be organized under `backend/data/buddy/` as the Buddy Home. This includes profile, policy, memories, summaries, revisions, command logs, evolution reports, and capability usage notes. Official templates, official skills, and user skill packages keep their own established locations.
