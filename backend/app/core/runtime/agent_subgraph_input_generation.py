    ...
    *,
    ...
    updated_runtime_config = {
        **runtime_config,
        ...
        "subgraph_input_provider_cost_budget_degradation": llm_meta.get("provider_cost_budget_degradation"),
        ...
        "subgraph_input_structured_output_repair_provider_cost_budget_degradation": repair_meta.get("provider_cost_budget_degradation"),
