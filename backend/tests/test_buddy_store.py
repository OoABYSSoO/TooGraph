...
class BuddyStoreTests(unittest.TestCase):
    ...
    def test_buddy_store_does_not_expose_legacy_memory_review_template_binding(self) -> None:
        self.assertFalse(hasattr(store, "load_memory_review_template_binding"))
        self.assertFalse(hasattr(store, "save_memory_review_template_binding"))
        self.assertFalse(hasattr(store, "MEMORY_REVIEW_TEMPLATE_BINDING_KEY"))
