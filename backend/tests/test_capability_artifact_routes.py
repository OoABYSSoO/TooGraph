    ...
    def test_capability_artifact_content_endpoint_reads_only_whitelisted_artifacts(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                blocked = client.get("/api/capability-artifacts/content", params={"path": "../outside.md"})
    ...
    def test_capability_artifact_file_endpoint_streams_media_inside_whitelist(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                blocked = client.get("/api/capability-artifacts/file", params={"path": "../clip.mp4"})
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                response = client.post(
                    "/api/capability-artifacts/uploads",
