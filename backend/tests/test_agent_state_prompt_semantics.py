...
class AgentStatePromptSemanticTests(unittest.TestCase):
    ...
    def test_auto_prompt_expands_result_package_outputs_as_virtual_states(self) -> None:
        ...
        try:
            ...
            self.assertNotIn("sourceType:", prompt)
            self.assertNotIn("sourceKey:", prompt)
            self.assertNotIn("sourceName:", prompt)
            self.assertNotIn("outputs:", prompt)
            self.assertNotIn("inputs:", prompt)
            self.assertNotIn("dynamic_search_result", prompt)
            self.assertNotIn("result_package", prompt)
    ...
    def test_auto_prompt_budgets_result_package_values_and_keeps_compact_artifact_refs(self) -> None:
        ...
        self.assertIn("key: capability_result_artifact_refs", prompt)
        ...
        self.assertNotIn("sourceName:", prompt)
        self.assertNotIn("outputs:", prompt)
        self.assertNotIn("inputs_summary:", prompt)
        self.assertNotIn("inputs_omitted:", prompt)
