...
class AgentSkillInputGenerationTests(unittest.TestCase):
    ...
    def test_skill_input_prompt_separates_state_inputs_from_llm_parameters(self) -> None:
                ...
                "toograph_page_operator": SkillDefinition(
                    ...
                    llmOutputSchema=[
                        SkillIoField(
                            ...
                            valueType="text",
                            required=True,
                            description="Semantic action generated by the LLM.",
                        )
                    ],
                )
            },
        ...
        self.assertIn("description: Semantic action generated by the LLM.", prompt)
            ...
            prompt = build_skill_input_system_prompt(
                ...
                skill_definitions={
                    "toograph_page_operator": SkillDefinition(
                        skillKey="toograph_page_operator",
                        name="TooGraph Page Operator",
                        llmOutputSchema=[SkillIoField(key="action", name="Action", valueType="text", required=True)],
                        sourcePath=str(skill_dir / "skill.json"),
                    )
                },
            ...
            prompt = build_skill_input_system_prompt(
                ...
                skill_definitions={
                    "extract_facts": SkillDefinition(
                        ...
                        name="Extract Facts",
                        llmOutputSchema=[SkillIoField(key="document_summary", name="Document Summary", valueType="text", required=True)],
                    )
                },
                state_schema={
