...
class AgentSkillInputGenerationTests(unittest.TestCase):
    ...
    def test_skill_input_prompt_separates_state_inputs_from_llm_parameters(self) -> None:
        prompt = build_skill_input_system_prompt(
            input_values={"page_context": "当前路径: /"},
            bindings=[
                ResolvedAgentSkillBinding(
                ...
                "toograph_page_operator": SkillDefinition(
                    ...
                    stateInputSchema=[
                        SkillIoField(
                            ...
                            valueType="markdown",
                            required=True,
                            description="Filtered page state consumed before LLM planning.",
                        )
                    ],
                    inputSchema=[
                        SkillIoField(
        ...
        self.assertIn("description: Filtered page state consumed before LLM planning.", prompt)
        self.assertIn("llmParameterSchema:", prompt)
