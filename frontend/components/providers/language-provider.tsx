...
const messages = {
  zh: {
    ...
    "settings.eyebrow": "设置",
    "settings.title": "只读运行与模型配置。",
    "settings.desc": "当前阶段主要展示模型、revision 和 evaluator 配置。",
    "runs.eyebrow": "运行记录",
  ...
  en: {
    ...
    "settings.title": "Readonly runtime and model settings.",
    "settings.desc": "This stage mainly exposes model, revision, and evaluator settings.",
    "runs.eyebrow": "Runs",
