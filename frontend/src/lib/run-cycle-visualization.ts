import type { CycleIterationRecord, CycleSummary, RunDetail } from "@/types/run";
...
function resolveCycleSummary(run: RunDetail): CycleSummary | null {
...
export function buildCycleVisualization(run: RunDetail): CycleVisualization {
