    ...
    return [
      {
        ...
        target: nodePortTarget(command.creationSource.sourceNodeId, "write", command.creationSource.stateKey),
  ...
  return [
    {
      ...
      target: nodePortTarget(command.sourceNodeId, "write", command.stateKey),
