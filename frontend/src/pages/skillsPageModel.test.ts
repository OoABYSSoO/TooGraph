...
const skills: SkillDefinition[] = [
  {
    ...
    llmOutputSchema: [{ key: "text", name: "Text", valueType: "text", required: true, description: "Source text" }],
    stateOutputSchema: [{ key: "rewritten", name: "Rewritten", valueType: "text", required: false, description: "Result" }],
