        ...
        operations: [
          {
            ...
            graph_edit_intents: [
              ...
              { kind: "move_node", nodeRef: "name_input", position: { x: 120, y: 240 } },
              { kind: "update_state", stateRef: "name", name: "规范化姓名", valueType: "json", value: { text: "Ada" }, color: "#0ea5e9" },
              { kind: "select_action", nodeRef: "name_input", actionKey: "local/file_writer", taskInstruction: "写入姓名。" },
              { kind: "update_input_config", nodeRef: "name_input", boundaryType: "file", value: "/tmp/name.txt" },
              { kind: "update_output_config", nodeRef: "output_1", displayMode: "markdown", persistEnabled: true, persistFormat: "md", fileNameTemplate: "name.md" },
              { kind: "delete_node", nodeRef: "name_input" },
              { kind: "restore_node", nodeRef: "name_input" },
              { kind: "bind_state", nodeRef: "name_input", stateRef: "name", mode: "write" },
              { kind: "connect_route", sourceRef: "condition_1", branchKey: "true", targetRef: "name_input" },
            ],
          },
        ],
