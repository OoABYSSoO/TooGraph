      ...
      <g class="buddy-mascot__stage" filter="url(#buddyMascotSoftness)">
        <g class="buddy-mascot__tail buddy-mascot__tail-rig">
          <path
            ...
            d="M0 194 C54 214 104 166 154 160 C212 152 240 112 260 82 C270 66 278 60 282 62"
          >
            <animate
              attributeName="d"
              dur="3.6s"
              ...
              values="M0 194 C54 214 104 166 154 160 C212 152 240 112 260 82 C270 66 278 60 282 62;M0 194 C62 198 124 178 178 150 C222 126 254 86 274 68 C278 64 280 62 282 62;M0 194 C70 180 138 148 196 116 C236 94 264 74 278 64 C280 62 282 62 282 62;M0 194 C64 184 122 198 170 162 C214 132 246 88 272 66 C276 62 280 60 282 62;M0 194 C54 214 104 166 154 160 C212 152 240 112 260 82 C270 66 278 60 282 62"
            />
          </path>
          <path
            class="buddy-mascot__tail-pose buddy-mascot__tail-pose--back-right"
            d="M0 194 C36 204 72 166 100 146 C130 124 158 82 156 62 C156 56 154 52 152 54"
          >
            <animate
              attributeName="d"
              dur="3.9s"
              ...
              keyTimes="0;0.25;0.5;0.75;1"
              keySplines="0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1"
              values="M0 194 C36 204 72 166 100 146 C130 124 158 82 156 62 C156 56 154 52 152 54;M0 194 C42 190 84 166 116 134 C144 106 166 76 156 58 C154 54 152 52 152 54;M0 194 C48 174 88 146 120 116 C140 96 152 72 154 58 C154 54 153 52 152 54;M0 194 C28 182 84 174 118 136 C148 104 168 78 158 58 C156 54 154 52 152 54;M0 194 C36 204 72 166 100 146 C130 124 158 82 156 62 C156 56 154 52 152 54"
            />
          </path>
          <path
            class="buddy-mascot__tail-pose buddy-mascot__tail-pose--back-center"
            d="M0 194 C-24 164 20 138 -2 108 C-20 82 -12 58 0 48 C8 54 12 62 8 72"
          >
            <animate
              attributeName="d"
              dur="4.2s"
              ...
              keyTimes="0;0.25;0.5;0.75;1"
              keySplines="0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1"
              values="M0 194 C-24 164 20 138 -2 108 C-20 82 -12 58 0 48 C8 54 12 62 8 72;M0 194 C-8 158 -8 124 -2 92 C0 70 4 54 8 46 C10 50 12 58 8 72;M0 194 C0 154 0 116 0 84 C0 62 0 50 2 44 C6 50 8 60 8 72;M0 194 C8 158 8 124 2 92 C0 70 -4 54 -8 46 C-10 50 -12 58 -8 72;M0 194 C24 164 -20 138 2 108 C20 82 12 58 0 48 C-8 54 -12 62 -8 72"
            />
          </path>
          <path
            class="buddy-mascot__tail-pose buddy-mascot__tail-pose--back-left"
            d="M0 194 C-36 204 -72 166 -100 146 C-130 124 -158 82 -156 62 C-156 56 -154 52 -152 54"
          >
            <animate
              attributeName="d"
              dur="3.9s"
              ...
              keyTimes="0;0.25;0.5;0.75;1"
              keySplines="0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1"
              values="M0 194 C-36 204 -72 166 -100 146 C-130 124 -158 82 -156 62 C-156 56 -154 52 -152 54;M0 194 C-42 190 -84 166 -116 134 C-144 106 -166 76 -156 58 C-154 54 -152 52 -152 54;M0 194 C-48 174 -88 146 -120 116 C-140 96 -152 72 -154 58 C-154 54 -153 52 -152 54;M0 194 C-28 182 -84 174 -118 136 C-148 104 -168 78 -158 58 C-156 54 -154 52 -152 54;M0 194 C-36 204 -72 166 -100 146 C-130 124 -158 82 -156 62 C-156 56 -154 52 -152 54"
            />
          </path>
          <path
            class="buddy-mascot__tail-pose buddy-mascot__tail-pose--left"
            d="M0 194 C-54 214 -104 166 -154 160 C-212 152 -240 112 -260 82 C-270 66 -278 60 -282 62"
          >
            <animate
              attributeName="d"
              dur="3.6s"
              ...
              keyTimes="0;0.25;0.5;0.75;1"
              keySplines="0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1;0.42 0 0.58 1"
              values="M0 194 C-54 214 -104 166 -154 160 C-212 152 -240 112 -260 82 C-270 66 -278 60 -282 62;M0 194 C-62 198 -124 178 -178 150 C-222 126 -254 86 -274 68 C-278 64 -280 62 -282 62;M0 194 C-70 180 -138 148 -196 116 C-236 94 -264 74 -278 64 C-280 62 -282 62 -282 62;M0 194 C-64 184 -122 198 -170 162 C-214 132 -246 88 -272 66 C-276 62 -280 60 -282 62;M0 194 C-54 214 -104 166 -154 160 C-212 152 -240 112 -260 82 C-270 66 -278 60 -282 62"
            />
          </path>
        </g>
