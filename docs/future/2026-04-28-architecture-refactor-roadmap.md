...
- Phase 139 后 `core/langgraph/runtime.py` 从约 1,040 行降到 467 行；execution callables 和图构建主流程仍留在 runtime，checkpoint、interrupt、cycle、setup 和 progress helper 已迁出。
