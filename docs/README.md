...
- [future/buddy-autonomous-agent-roadmap.md](future/buddy-autonomous-agent-roadmap.md)
  ...
  - 包含 graph-first 运行模型、Buddy Home、伙伴循环子图化、子图组件、skill manifest 契约、`capability` state、`result_package` 动态结果包、技能说明胶囊、技能绑定 state、`autonomous_decision`、能力选择、Skill 生成能力和 function call 取舍
